...
from . import (
    FairseqIncrementalDecoder, FairseqEncoder, FairseqLanguageModel, FairseqDROLanguageModel,
...
@register_model('transformer_dro_lm')
class TransformerDROLanguageModel(FairseqDROLanguageModel):
    def __init__(self, decoder):
        super().__init__(decoder)
    ...
    def build_model(cls, args, task):
        ...
        return TransformerDROLanguageModel(decoder)
...
@register_model_architecture('transformer_dro_lm', 'transformer_dro_lm')
def transformer_dro_lm(args):
    base_lm_architecture(args)
