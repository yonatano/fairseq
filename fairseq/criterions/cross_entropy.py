...
@register_criterion('cross_entropy_dro')
class CrossEntropyDROCriterion(FairseqCriterion):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--eta-hardcoded', type=float, help='Set this to fix eta during training.')
